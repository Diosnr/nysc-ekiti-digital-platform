...
const PERMISSIONS: { key: string; description: string; module: string }[] = [
  ...
  { key: "pcm:delete", description: "Delete PCM records (Super Admin)", module: "pcm" },
  ...
  { key: "community:manage", description: "Create and delete communities for forms", module: "camp" },
...
async function main() {
  ...
  const starterRoles = [
    ...
    { name: "Platoon Officer", description: "Platoon, kit, attendance, exit initiation" },
