        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed">
              National Youth Service Corps — Ekiti State Secretariat. Serving the nation through structured national service.
            </p>
          </div>
          <div>
            <p className="text-sm font-semibold uppercase tracking-wider text-white">Explore</p>
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link href="/about" className="hover:text-white">About NYSC Ekiti</Link></li>
              <li><Link href="/orientation-camp" className="hover:text-white">Orientation Camp</Link></li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li><Link href="/pcm" className="hover:text-white">PCM Services</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li><Link href="/contact" className="hover:text-white">Contact form & details</Link></li>
            </ul>
          </div>
        </div>
        <div className="mt-10 border-t border-slate-700 pt-6 text-center text-xs text-slate-500">
          <p>© {new Date().getFullYear()} National Youth Service Corps, Ekiti State. All rights reserved.</p>
          <p className="mt-1">Official digital information and operations platform.</p>
        </div>
      </div>
    </footer>
  );
